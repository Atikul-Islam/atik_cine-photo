...
const Blog = () => {
    ...
    return (
        <div className='mb-5'>
        <h4 className='text-2xl font-bold mb-2'>What are the differences between SQL and NoSQL?</h4>
        <p className='mb-5'>SQL pronounced as “S-Q-L” or as “See-Quel” is primarily called RDBMS or Relational Databases, whereas NoSQL is a Non-relational or Distributed Database.
        ...
        <h4 className='text-2xl font-bold mb-2'>What is JWT, and how does it work?</h4>
        <p className='mb-5'>
        ...
        <h4 className='text-2xl font-bold mb-2'>What is the difference between javascript and NodeJS?</h4>
        <p className='mb-5'>JavaScript is a proper high-level programming language used to create web scripts whereas Node.js is a run time environment built on google’s v8 engine.
        ...
        <h4 className='text-2xl font-bold mb-2'>How does NodeJS handle multiple requests at the same time?</h4>
        <p className='mb-5'>NodeJS receives multiple client requests and places them into EventQueue. NodeJS is built with the concept of event-driven architecture. NodeJS has its own EventLoop which is an infinite loop that receives requests and processes them. EventLoop is the listener for the EventQueue.
